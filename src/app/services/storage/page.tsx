  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative h-[360px] overflow-hidden md:h-[480px]">
        <Image src="/images/zhdz_d_09.jpg" alt="储能电站并网性能检测服务" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0c2b57]/80 via-[#1554a0]/60 to-[#0e2a57]/90" />
        <div className="absolute inset-0 flex flex-col items-center justify-center pt-16">
          <div className="text-center">
            <span className="fade-up mb-4 block text-sm font-semibold tracking-[0.2em] text-[#9fbbe7] uppercase md:text-base">ENERGY STORAGE TESTING</span>
      ...
      <div className="relative z-10 border-b border-border/50 bg-white py-3">
        <div className="site-shell">
          <span className="text-sm font-medium text-text-tertiary">
            ...
            <span className="mx-2 opacity-50">&gt;</span>
            <span className="text-brand-primary">储能电站检测</span>
          </span>
        </div>
      </div>
        ...
        <div className="site-shell">
          ...
          <div className="mb-16 grid items-center gap-8 lg:grid-cols-12 lg:gap-16" data-reveal>
            ...
            <div className="lg:col-span-7">
              <div className="rounded-2xl border-l-4 border-[#1a63c4] bg-[#f8fafc] p-6 text-base leading-loose text-text-secondary shadow-sm md:p-8 md:text-lg">
                大规模储能电站接入电力系统，其是否符合国家标准将直接决定电网的安全稳定。源讯通作为独立的第三方专业检测机构，累计为华能集团、大唐集团等数百发电商提供服务，以“公正、公开、专业”验证场站的<span className="font-semibold text-[#1a63c4]">充放电性能、转换效率、以及故障电压穿越</span>等一系列核心涉网能力。
              </div>
            </div>
          </div>
          ...
          <div className="mt-8" data-reveal="1">
            <div className="mb-10 text-center md:mb-14">
              ...
              <p className="mt-3 font-medium text-text-secondary">全面覆盖储能全生命周期内的核心性能测试</p>
            </div>
